...
#include "mpu6050.h"
extern int16_t accelerate_g ;
extern int16_t roll_x ;
extern int16_t roll_y ;
extern int16_t x_acc ;
extern int16_t y_acc  ;
extern int16_t z_acc  ;
 static uint32_t lastSendMs ;
 extern const uint32_t SEND_INTERVAL_MS ;   /* ≥ 5 events per second max */
 extern UART_HandleTypeDef huart3;
 extern const char *startupMsg ;
